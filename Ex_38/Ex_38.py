...
# Программа переписана с урока, прошу Вас не принять пустую работу, чтоб у меня появилось доп. время для сдачи ДЗ)
...
def search_file(path1, search_input):
    with open('phones.txt', 'r') as data:
        lst = data.readlines()
        flag1 = False
        result = '\n'
        for line in lst:
